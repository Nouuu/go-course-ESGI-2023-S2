...
import (
	...
	"03-fonctions-packages.3.4c/dealership"
	"log"
)
...
func main() {
	...
	cars := myDealership.FindCarsByCriteria(map[string]string{"brand": "Renault", "year": "2018"})
	log.Println("Voitures trouvées :", cars)
	cars = myDealership.FindCarsByCriteria(map[string]string{"color": "blue"})
	log.Println("Voitures trouvées :", cars)
}
